...
<br><center><h3>ALL ARTICLES</h3></center><br>
<?php
		$results=mysqli_query($con,"SELECT `art_id`, `heading`, `content`, `image`, 
		`aproval`, `date`, `regid` FROM `art` WHERE `aproval`='aprove' and `remove_status`='on' ");
...
<li><i ></i>  <span><a href="admin_art_delete.php?art_id=<?php echo $row['art_id'];?>" >DELETE</a></span></li>
</ul>
<hr>
<p><?php echo $t?></p>
