...
<div style="background-color: #333;
  ...
  <a href="ad_ad_art.php">Add article </a> 
<a href="admin_edit_article.php">Edit your article </a>   
 <a href="ad_view_all.php">View all  article </a> 
  <a href="logout.php">logout</a> 
</div>

<br>
<center><h3>APPROVE USER ARTICLE</h3></center>
<br>
<?php
		$results=mysqli_query($con,"SELECT `art_id`, `heading`, `content`, `image`, `aproval`, `date`, `regid` FROM `art` WHERE `aproval`='request' ");
...
$str4=implode('',array_slice($words,3,$h));
$str5=implode('',array_slice($words,$h));
...
<li><i ></i>  <span><a href="apv.php?art_id=<?php echo $row['art_id'];?>" >APPROVE</a></span></li>
</ul>
<hr>
<p><?php echo $t?></p>
<p><?php// echo $str2?></p>
